...
\small{}
\begin{itemize}
  \item Cognitive capabilities of the platform and early experimentation for ensuring power saving capabilities have also been performed.
\end{itemize}
...
\begin{itemize}
  \item The employment of stay time information could be employed for reducing sensors sampling:
\end{itemize}
...
%   \begin{itemize}
%     \item It analysis state of art solutions aimed at performing power-aware sensing. 
%     \item It proposes the taxonomy of power-aware sensing solutions previously described.
%   \end{itemize}
...
%   \begin{itemize}
%     \item It describes the experimentation performed for ensuring the feasibility of on-device mobility analysis and the energy savings when compared against an MCC oriented approach.
%   \end{itemize}
% \end{itemize}
% \end{frame}
...
\toprule
\multicolumn{2}{c}{\textbf{Space information}} & \multicolumn{2}{c}{\textbf{Time information}}      \\ \midrule
Total fixes                 & 6,652            & Total time             & 6275.15 minutes           \\
Fixes inside stay points    & 6380 (95.9\%)    & Total stay points time & 5995.08 minutes (95.53\%) \\
Fixes on trajectory         & 272 (4.1\%)      & Total trajectory time  & 280 minutes (4.47\%)      \\
Detected stay points        & 6                &                        &                           \\
Total trajectories          & 26               &                        &                           \\ \bottomrule
\end{tabular}%
}
\caption{Space and time summary of mobility information}
\end{table}
...
\toprule
\multicolumn{1}{c}{\textbf{\#}} & \multicolumn{1}{c}{\textbf{Semantic}} & \multicolumn{1}{c}{\textbf{Visit count}} & \multicolumn{1}{c}{\textbf{Stay time (minutes)}} & \multicolumn{1}{c}{\textbf{Absolute weight}} & \multicolumn{1}{c}{\textbf{Relative weight}} \\ \midrule
1 & Park & 3 & 252 & 4.02\% & 4.20\% \\
2 & Home & 8 & 3,825 & 60.97\% & 63.82\% \\
3 & Cinvestav & 4 & 1,549 & 24.69\% & 25.85\% \\
4 & Fast food & 4 & 72 & 1.15\% & 1.21\% \\
5 & Bob's home & 7 & 220 & 3.50\% & 3.67\% \\
6 & Coffee shop & 1 & 75 & 1.20\% & 1.25\% \\ \bottomrule
\end{tabular}%
}
\caption{Stay points weight and visits information}
\end{table}
\end{frame}
\end{document}
