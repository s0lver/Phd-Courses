...
% TODO: The solution section has to be updated with the new design that the controller has received.
% TODO: Also, the previous content has to be reduced as there are only 30 minutes. In total, I expect to have at most 30 slides, no more.
% For instance, the HAR module features has to be updated !
...
% \input{sections/additional-slides}
