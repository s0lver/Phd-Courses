...
\begin{block}{\small \textbf{Trajectory mode}}
{
  ...
  \captionof{figure}{GPS sampling adaptation based on the speed tendency of detected transportation modes.}
}
\end{block}
...
{
  \centering
  \includegraphics[width=0.67\linewidth]{vectors/brooks-inspired-controller}
  \captionof{figure}{The subsumption architecture of the controller and the reactions to different coarse grain mobility events.}
}
\end{block}
...
%   \begin{itemize}
%     \item The sampling rate is increased by implementing a GPS sampling rate assisted by the speed tendency of detected transportation modes.
%   \end{itemize}
% \end{itemize}
% \end{block}
