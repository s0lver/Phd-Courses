...
\begin{itemize}
  ...
  % \item Formally defined as:$ev = ev(id, \left\{ a_1,a_2,\ldots, a_n \right\}, t)$, where $id$ is an identifier, $\left\{ a_1,a_2,\ldots, a_n \right\}$ is a list of $n$ associated attributes, and $t$ the timestamp.
